...
\begin{enumerate}
    ...
    \item Testing the models using the non-augmneted test datassets and obtaing the test metrics (cosine similarity and percision@K) and comparing the results.
\end{enumerate}
\par\vspace{1em}